...
// SymbolDummy.m
//
//    //  SymbolDummy.m    //  ffi_test    //    //  Created by vincepzhang on 2024/7/2.    //
...
#import "live_c_api/pusher_dart_adapter.h"
#import "live_c_api/v2tx_live_def.h"
#import "live_c_api/v2tx_live_player.h"
#import "live_c_api/v2tx_live_premier.h"
#import "live_c_api/v2tx_live_pusher.h"
#import "trtc_c_api/chorus_music_player.h"
...
+(void)liteavCFunction {
  ...
  // v2tx_live_pusher.h
  create_v2tx_live_pusher(0);
  release_v2tx_live_pusher(NULL);
  v2tx_live_pusher_set_render_view(NULL, NULL);
  v2tx_live_pusher_set_render_mirror(NULL, 0);
  v2tx_live_pusher_set_encoder_mirror(NULL, 0);
  v2tx_live_pusher_set_render_rotation(NULL, 0);
  v2tx_live_pusher_set_render_fill_mode(NULL, 0);
  v2tx_live_pusher_start_camera(NULL, 0);
  v2tx_live_pusher_stop_camera(NULL);
  v2tx_live_pusher_start_microphone(NULL);
  v2tx_live_pusher_stop_microphone(NULL);
  v2tx_live_pusher_start_virtual_camera(NULL, NULL);
  v2tx_live_pusher_stop_virtual_camera(NULL);
  v2tx_live_pusher_pause_audio(NULL);
  v2tx_live_pusher_resume_audio(NULL);
  v2tx_live_pusher_pause_video(NULL);
  v2tx_live_pusher_resume_video(NULL);
  v2tx_live_pusher_start_push(NULL, "");
  v2tx_live_pusher_stop_push(NULL);
  v2tx_live_pusher_is_pushing(NULL);
  v2tx_live_pusher_set_audio_quality(NULL, 0);
  v2tx_live_pusher_set_video_quality(NULL, NULL);
  v2tx_live_pusher_get_audio_effect_manager(NULL);
  v2tx_live_pusher_get_device_manager(NULL);
  v2tx_live_pusher_set_beauty_style(NULL, 0, 0, 0, 0);
  v2tx_live_pusher_enable_sharpness_enhancement(NULL, 0);
  v2tx_live_pusher_set_lut_color_filter(NULL, NULL);
  v2tx_live_pusher_set_lut_color_filter_strength(NULL, 0.0);
  v2tx_live_pusher_snapshot(NULL);
  v2tx_live_pusher_set_watermark(NULL, "", 0, 0, 0);
  v2tx_live_pusher_enable_volume_evaluation(NULL, 0);
  v2tx_live_pusher_enable_custom_video_render(NULL, 0, 0, 0);
  v2tx_live_pusher_enable_custom_video_process(NULL, 0, 0, 0);
  v2tx_live_pusher_enable_custom_video_capture(NULL, 0);
  v2tx_live_pusher_send_custom_video_frame(NULL, NULL);
  v2tx_live_pusher_enable_custom_audio_capture(NULL, 0);
  v2tx_live_pusher_send_custom_audio_frame(NULL, NULL);
  v2tx_live_pusher_send_sei_message(NULL, 0, NULL, 0);
  
  v2tx_live_pusher_start_system_audio_loopback(NULL, "");
  v2tx_live_pusher_stop_system_audio_loopback(NULL);
  v2tx_live_pusher_set_system_audio_loopback_volume(NULL, 0);
  
  v2tx_live_pusher_start_screen_capture(NULL);
  v2tx_live_pusher_stop_screen_capture(NULL);
  v2tx_live_pusher_show_debug_view(NULL, 0);
  v2tx_live_pusher_set_property(NULL, "", NULL);
  v2tx_live_pusher_get_property(NULL, "");
  v2tx_live_pusher_set_mix_transcoding_config(NULL, NULL);

  // pusher_dart_adapter.h
  LiteavFFIRegisterPusherListener(0, NULL);
  LiteavFFIUnRegisterPusherListener(NULL);
  LiteavFFIRegisterMusicPreloadObserver(0, NULL);
  LiteavFFIUnRegisterMusicPreloadObserver(0, NULL);
  LiteavFFIRegisterMusicPlayObserver(0, NULL, "");
  LiteavFFIUnRegisterMusicPlayObserver(0, NULL, "");
  LiteavFFIRegisterDeviceChangeObserver(0, NULL);
  LiteavFFIUnRegisterDeviceChangeObserver(0, NULL);
  LiteavFFIRegisterPusherPreprocessListener(NULL, 0);
  LiteavFFIUnRegisterPusherPreprocessListener(NULL);

  ///MARK: Chorus Music Player
  LiteavFFIRegisterChorusPlayerObserver(0, NULL);
  LiteavFFIUnRegisterChorusPlayerObserver(0, NULL);
  
  chorus_music_player_create(NULL, NULL);
  chorus_music_player_destroy(NULL);
  chorus_music_player_set_chorus_role(NULL, 0, NULL);
  chorus_external_music_params_t chorus_external_music_params_t_;
  chorus_music_player_load_external_music(NULL, chorus_external_music_params_t_);
  chorus_music_player_start(NULL);
  chorus_music_player_stop(NULL);
  chorus_music_player_pause(NULL);
  chorus_music_player_resume(NULL);
  chorus_music_player_seek(NULL, 0);
  chorus_music_player_switch_music_track(NULL, 0);
  chorus_music_player_set_playout_volume(NULL, 0);
  chorus_music_player_set_publish_volume(NULL, 0);
  chorus_music_player_set_music_pitch(NULL, 0);
  chorus_music_player_call_experimental_api(NULL, NULL);
}
