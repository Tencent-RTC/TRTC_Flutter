...
///  BeautyProcessEnterPage.dart
///  TRTC-API-Example-Dart
class BeautyProcessEnterPage extends StatefulWidget {
  const BeautyProcessEnterPage({Key? key}) : super(key: key);

  @override
  _BeautyProcessEnterPageState createState() => _BeautyProcessEnterPageState();
}

class _BeautyProcessEnterPageState extends State<BeautyProcessEnterPage> {
