...
class AudioEffectManager {
	...
	*/
	public func startPlayMusic(call: FlutterMethodCall, result: @escaping FlutterResult) {
		if let musicParam = CommonUtils.getParamByKey(call: call, result: result, param: "musicParam") as? String {
			...
			txAudioEffectManager.startPlayMusic(param, onStart: { [weak self] errCode in
	...
	*/
	public func stopPlayMusic(call: FlutterMethodCall, result: @escaping FlutterResult) {
		if let id = CommonUtils.getParamByKey(call: call, result: result, param: "id") as? Int32 {
	...
	*/
	public func setMusicPitch(call: FlutterMethodCall, result: @escaping FlutterResult) {
		if let volume = CommonUtils.getParamByKey(call: call, result: result, param: "id") as? Int32,
		   let pitch = Double.init((CommonUtils.getParamByKey(call: call, result: result, param: "pitch") as? String)!) {
	...
	*/
	public func setMusicSpeedRate(call: FlutterMethodCall, result: @escaping FlutterResult) {
		if let id = CommonUtils.getParamByKey(call: call, result: result, param: "id") as? Int32,
		   let speedRate = Double.init((CommonUtils.getParamByKey(call: call, result: result, param: "speedRate") as? String)!) {
	...
	*/
	public func seekMusicToPosInMS(call: FlutterMethodCall, result: @escaping FlutterResult) {
		if let id = CommonUtils.getParamByKey(call: call, result: result, param: "id") as? Int32,
		   let pts = CommonUtils.getParamByKey(call: call, result: result, param: "pts") as? Int {
	...
	*/
	public func getMusicDurationInMS(call: FlutterMethodCall, result: @escaping FlutterResult) {
		let path = CommonUtils.getParamByKeyCanBeNull(call: call, result: result, param: "path") as? String
    ...
    public func preloadMusic(call: FlutterMethodCall, result: @escaping FlutterResult) {
        if let musicParam = CommonUtils.getParamByKey(call: call, result: result, param: "preloadParam") as? String {
            let musicParam = JsonUtil.getDictionaryFromJSONString(jsonString: musicParam)
            let param = TXAudioMusicParam()
