...
public class MainActivity extends FlutterActivity {
  ...
  public void configureFlutterEngine(@NonNull FlutterEngine flutterEngine) {
    ...
    channel = new MethodChannel(flutterEngine.getDartExecutor().getBinaryMessenger(), "serviceControl");
    channel.setMethodCallHandler(((call, result) -> {
      switch (call.method) {
        case "startVideoForegroundService":
          startVideoForegroundService();
          break;
        case "stopVideoForegroundService":
          stopVideoForegroundService();
          break;
        default:
          break;
      }
  ...
  private void startVideoForegroundService() {
    Log.i("VideoForegroundService", "startVideoForegroundService");
    com.tencent.trtc_demo.VideoForegroundService.start(this);
  }

  private void stopVideoForegroundService() {
    Log.i("VideoForegroundService", "stopVideoForegroundService");
    com.tencent.trtc_demo.VideoForegroundService.stop(this);
  }
