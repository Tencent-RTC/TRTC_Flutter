 ...
 * 视频视图
 */
public class TRTCCloudVideoPlatformView extends PlatformViewFactory
    ...
    public PlatformView create(Context context, int viewId, Object args) {
        ...
        TXCLog.i(TRTCCloudPlugin.TAG, "create a new TRTCCloudVideoPlatformView, viewId = " + viewId);
    ...
    public void onMethodCall(MethodCall call, Result result) {
        ...
        TXCLog.i(TRTCCloudPlugin.TAG, "TRTCCloudVideoPlatformView|channel=" + channelName +
