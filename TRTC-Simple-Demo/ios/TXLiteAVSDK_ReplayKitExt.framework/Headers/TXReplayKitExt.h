...
///
/// When the screen recording is stopped through the system control center, it will call back RPBroidCastSamplehandler.broadcastPaused, and call it in the broadcastPaused method
...
///
/// When the screen recording is stopped through the system control center, it will call back RPBroidCastSamplehandler.broadcastFinished and call in the broadcastFinished method
...
- (void)sendVideoSampleBuffer:(CMSampleBufferRef)sampleBuffer __attribute__((deprecated("use sendSampleBuffer:withType instead")));
