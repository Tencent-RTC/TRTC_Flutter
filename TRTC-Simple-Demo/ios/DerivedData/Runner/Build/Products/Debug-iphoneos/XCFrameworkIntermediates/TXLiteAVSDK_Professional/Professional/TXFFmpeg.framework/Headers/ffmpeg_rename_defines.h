...
#define av_add_index_entry liteav_av_add_index_entry
#define av_append_packet liteav_av_append_packet
#define av_apply_bitstream_filters liteav_av_apply_bitstream_filters
#define av_assert0_fpu liteav_av_assert0_fpu
#define av_codec_ffversion liteav_av_codec_ffversion
#define av_codec_get_codec_properties liteav_av_codec_get_codec_properties
#define av_codec_get_id liteav_av_codec_get_id
#define av_codec_get_max_lowres liteav_av_codec_get_max_lowres
#define av_codec_get_tag2 liteav_av_codec_get_tag2
#define av_codec_is_decoder liteav_av_codec_is_decoder
#define av_codec_is_encoder liteav_av_codec_is_encoder
#define av_cpb_properties_alloc liteav_av_cpb_properties_alloc
#define av_demuxer_open liteav_av_demuxer_open
#define av_fast_padded_malloc liteav_av_fast_padded_malloc
#define av_fast_padded_mallocz liteav_av_fast_padded_mallocz
#define av_filename_number_test liteav_av_filename_number_test
#define av_fmt_ctx_get_duration_estimation_method liteav_av_fmt_ctx_get_duration_estimation_method
#define av_format_ffversion liteav_av_format_ffversion
#define av_format_get_probe_score liteav_av_format_get_probe_score
#define av_format_inject_global_side_data liteav_av_format_inject_global_side_data
#define av_fourcc_make_string liteav_av_fourcc_make_string
#define av_get_audio_frame_duration liteav_av_get_audio_frame_duration
#define av_get_audio_frame_duration2 liteav_av_get_audio_frame_duration2
#define av_get_bits_per_sample liteav_av_get_bits_per_sample
#define av_get_codec_tag_string liteav_av_get_codec_tag_string
#define av_get_exact_bits_per_sample liteav_av_get_exact_bits_per_sample
#define av_get_frame_filename liteav_av_get_frame_filename
#define av_get_frame_filename2 liteav_av_get_frame_filename2
#define av_get_packet liteav_av_get_packet
#define av_get_pcm_codec liteav_av_get_pcm_codec
#define av_get_picture_type_char liteav_av_get_picture_type_char
#define av_get_profile_name liteav_av_get_profile_name
#define av_get_time_base_q liteav_av_get_time_base_q
#define av_guess_frame_rate liteav_av_guess_frame_rate
#define av_guess_sample_aspect_ratio liteav_av_guess_sample_aspect_ratio
#define av_hwaccel_next liteav_av_hwaccel_next
#define av_index_search_timestamp liteav_av_index_search_timestamp
#define av_lockmgr_register liteav_av_lockmgr_register
#define av_new_program liteav_av_new_program
#define av_program_add_stream_index liteav_av_program_add_stream_index
#define av_read_pause liteav_av_read_pause
#define av_read_play liteav_av_read_play
#define av_register_hwaccel liteav_av_register_hwaccel
#define av_stream_add_side_data liteav_av_stream_add_side_data
#define av_stream_get_codec_timebase liteav_av_stream_get_codec_timebase
#define av_stream_get_end_pts liteav_av_stream_get_end_pts
#define av_stream_get_parser liteav_av_stream_get_parser
#define av_stream_new_side_data liteav_av_stream_new_side_data
#define av_url_split liteav_av_url_split
#define av_util_ffversion liteav_av_util_ffversion
#define av_xiphlacing liteav_av_xiphlacing
#define avcodec_align_dimensions liteav_avcodec_align_dimensions
#define avcodec_align_dimensions2 liteav_avcodec_align_dimensions2
#define avcodec_chroma_pos_to_enum liteav_avcodec_chroma_pos_to_enum
#define avcodec_configuration liteav_avcodec_configuration
#define avcodec_copy_context liteav_avcodec_copy_context
#define avcodec_default_execute liteav_avcodec_default_execute
#define avcodec_default_execute2 liteav_avcodec_default_execute2
#define avcodec_enum_to_chroma_pos liteav_avcodec_enum_to_chroma_pos
#define avcodec_fill_audio_frame liteav_avcodec_fill_audio_frame
#define avcodec_get_class liteav_avcodec_get_class
#define avcodec_get_context_defaults3 liteav_avcodec_get_context_defaults3
#define avcodec_get_frame_class liteav_avcodec_get_frame_class
#define avcodec_get_subtitle_rect_class liteav_avcodec_get_subtitle_rect_class
#define avcodec_is_open liteav_avcodec_is_open
#define avcodec_license liteav_avcodec_license
#define avcodec_profile_name liteav_avcodec_profile_name
#define avcodec_string liteav_avcodec_string
#define avcodec_version liteav_avcodec_version
#define avformat_configuration liteav_avformat_configuration
#define avformat_flush liteav_avformat_flush
#define avformat_get_class liteav_avformat_get_class
#define avformat_license liteav_avformat_license
#define avformat_match_stream_specifier liteav_avformat_match_stream_specifier
#define avformat_network_deinit liteav_avformat_network_deinit
#define avformat_query_codec liteav_avformat_query_codec
#define avformat_queue_attached_pictures liteav_avformat_queue_attached_pictures
#define avformat_seek_file liteav_avformat_seek_file
#define avformat_transfer_internal_stream_timing_info liteav_avformat_transfer_internal_stream_timing_info
#define avformat_version liteav_avformat_version
#define avpriv_bprint_to_extradata liteav_avpriv_bprint_to_extradata
#define avpriv_codec_get_cap_skip_frame_fill_param liteav_avpriv_codec_get_cap_skip_frame_fill_param
#define avpriv_find_pix_fmt liteav_avpriv_find_pix_fmt
#define avpriv_find_start_code liteav_avpriv_find_start_code
#define avpriv_new_chapter liteav_avpriv_new_chapter
#define avpriv_set_pts_info liteav_avpriv_set_pts_info
#define avpriv_toupper4 liteav_avpriv_toupper4
#define avutil_configuration liteav_avutil_configuration
#define avutil_license liteav_avutil_license
#define avutil_version liteav_avutil_version
#define ffio_limit liteav_ffio_limit
#define swr_alloc liteav_swr_alloc
#define swr_get_class liteav_swr_get_class
//vod
