...
////////////////////////////////////////////////////////////////////////////////
    ...
    protected:
        ...
        liteav_soundtouch::LONG_SAMPLETYPE decimateSum;
        ...
        liteav_soundtouch::FIFOSampleBuffer *buffer;
        ...
        int decimate(liteav_soundtouch::SAMPLETYPE *dest,      ///< Destination buffer
            const liteav_soundtouch::SAMPLETYPE *src, ///< Source sample buffer
            int numsamples                     ///< Number of source samples.
        );

        /// Calculates amplitude envelope for the buffer of samples.
        /// Result is output to 'samples'.
        void calcEnvelope(liteav_soundtouch::SAMPLETYPE *samples,  ///< Pointer to input/output data buffer
    ...
    public:
        ...
        void inputSamples(const liteav_soundtouch::SAMPLETYPE *samples,    ///< Pointer to input/working data buffer
            int numSamples                            ///< Number of samples in buffer
        );
