...
6.**Enabling/disabling the mic**

```
// Turn the mic on: start local audio capturing and publishing.
// quality: audio quality
//* Smooth (suitable for voice call): TRTCAudioQuality.speech
//* Default: TRTCAudioQuality.defaultMode
//* HD (suitable for music): TRTCAudioQuality.music
trtcCloud.startLocalAudio(TRTCAudioQuality.defaultMode);

// Turn the mic off: stop local audio capturing and publishing.
