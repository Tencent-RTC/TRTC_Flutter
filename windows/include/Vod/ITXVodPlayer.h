 ...
 * @param repeat Does it need to be played repeatedly true: this media file will be played repeatedly false: the media
  * file will be played only once, and it will stop automatically after the end
 * @return ITXVodPlayer pointer note: a compilation error occurred if delete ITXVodPlayer*, please use
  * destroyTXVodPlayer.
 */
...
LITEAV_API void destroyTXVodPlayer(ITXVodPlayer** pTXVodPlayer);  // NOLINT(readability/braces)
}
  // NOLINT(whitespace/indent)
class ITXVodPlayer {
   protected:
 ...
 */
     ...
     * @note Starting from version 10.7, the Licence needs to be set through {@link TXLiveBase#setLicence} before it
      * can be played successfully, otherwise the playback will fail (black screen), and it can only be set once
      * globally. Live Licence, UGC
     * Licence, and Player Licence can all be used. If you have not obtained the above Licence, you can [quickly apply
      * for a beta Licence for free](https://cloud.tencent.com/act/event/License) To play, the official licence needs
      * to be
     * [purchased](https://cloud.tencent.com/document/product/881/74588#.E8.B4.AD.E4.B9.B0.E5.B9.B6.E6.96
      * .B0.E5.BB.BA.E6.AD.A3.E5.BC.8F.E7.89.88-license).
     *
     ...
     */
    virtual void seek(uint64_t msPos) = 0;  // NOLINT(runtime/int)
     ...
     * @param rotation Support TRTCVideoRotation90 、 TRTCVideoRotation180 and TRTCVideoRotation270 default is
      * TRTCVideoRotation0.
     ...
     *
     * @param mode Fill (the picture may be stretched and cropped) or fit (the picture may have black borders),default:
